...
GO
/****** Object:  StoredProcedure [dbo].[sp_sys_VentaEntradas_Entradas_F700_Cine]    Script Date: 8/1/2025 15:40:34 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	--DECLARE @Fecha_Desde DATETIME='7-1-2024';
	--DECLARE @Fecha_Hasta DATETIME='7-30-2024';

	--CUANDO hace LA MISMA pelicula en VARIOS EVENTOS
	DECLARE @Codigo_Incaa NVARCHAR(50)=NULL; --NULL;--'64240248';--'63240017';'AE240120';
	...
	--boc = $"{detalle.CodigoSala}{fechat.Substring(2,fechat.Length-2)}{detalle.NumeroFuncion}{detalle.LetraTarifa}1";

	--SELECT f.FechaHora_Funcion FROM @Funciones f GROUP BY f.FechaHora_Funcion;
	...
	--SELECT DISTINCT FechaHora_Funcion, Numero_Funcion FROM  @Funciones
	...
	SELECT  
			...
			--
			--ISNULL(b.Serie_Letra,'') AS Letra_Tarifa
